  ...
  return (
    <div className="p-10 w-full flex flex-col lg:flex-row items-center lg:items-start justify-center space-x-4 mx-auto space-y-4 lg:space-y-0">
        <div className="flex space-x-4">
            ...
            <Skeleton className="inline lg:hidden w-[280px] h-[280px] rounded-md"/>
            <Skeleton className="hidden lg:inline w-[400px] h-[300px] rounded-md"/>
        </div>

        <div className="w-[400px] h-[500px] sm:w-[520px] sm:h-[780px] rouned-md space-y-2 border p-2 animate-pulse">
