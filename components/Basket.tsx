...
function Basket() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
        <ul className="space-y-6 divide-y-2">
        ...
        <div className="flex flex-col justify-end p-5">
            <p className="font-bold text-2xl text-right text-walmart mb-5">Total: {basketTotal}</p>

            <Button className="mt-5 h-20 bg-walmart hover:bg-walmart/50">Checkout</Button>
